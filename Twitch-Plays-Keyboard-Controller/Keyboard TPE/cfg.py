...
NICK = "username"                   # Twitch username, lowercase
PASS = "oauth:XXXXXXXXXXXXXXX" # your Twitch OAuth token ( https://twitchapps.com/tmi/ )



""" Special Keys """
RESET = "backspace"         # This key will delete the current message being built
